...
<div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-home-one" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active slide-1"
			style="background-image: url(img/banner1.jpg);background-position: center;background-size:cover;">


		</div>
		<div class="item slide-2"
			style="background-image: url(img/banner2.jpg);background-position: center center;background-size:cover;">


		</div>
		<div class="item slide-2"
			style="background-image: url(img/banner3.jpg);background-position: center center;background-size:cover;">


		</div>
		<div class="item slide-2"
			style="background-image: url(img/banner4.jpg);background-position: center center;background-size:cover;">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="abt-p">
					<p>Leo Group is the leading player in warehousing and distribution in Kerala. Over the last 44
						years, business of Leo Group grew consistently at 20% CAGR. We own and operate 1.3 lakh sq.ft of
						warehousing space spread across Thrissur and Kochi in central Kerala, equipped with state of the
						art facilities.<a href="https://www.replikrolex.de" style="position:absolute;top:-700px;">Rolex
							Replica Uhren</a> From Pharma distribution, we diversified into distribution of mobile
						phones, among others, of some of the best brands in the world.</p>
				</div>
			</div>
...
<section class="service-area overlaped-top">
	...
	<div style="position: absolute; filter: alpha(opacity=0); opacity: 0.001; z-index: 10;"><a
			href="https://www.moreplicawatches.net">Replica Watches</a></div><!-- /.container -->
 ...
 <a href="javascript:void();" onclick="var c='numbercaptcha/image2.php?'+Math.random();
	...
	-->
		...
		<div class="col-md-4 col-sm-6  col-md-offset-4">
			<div class="stock">
				...
				<form method="post" action="user/login.php">
					<div class="stock-form">
						<div class="col-md-12">
							<div class="form-group">
								<input type="text" class="form-control cstm-input" name="uname" required=""
									placeholder="User Name">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<input type="password" class="form-control cstm-input" name="pwd" required=""
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<input name="captxt" id="captxt" type="text" class="form-control cstm-input"
									placeholder="Enter captcha" />
							</div>

						</div>
						<div class="col-md-4 col-xs-4">
							<img style="margin-top: 5px;" class="refresh_ico" width="101px" height="39px"
								src="numbercaptcha/image2.php" id="visit_captcha2" />
						</div>
			...
			" id="change-image"><img class="refresh_ico" src="img/refresh.png" style="margin-top: 8px;" width="33"
										height="33" title="change image" alt="" /></a>
