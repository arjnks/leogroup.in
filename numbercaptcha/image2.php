<?php
	...
	session_start();
	$_SESSION['security_number2']=rand(10000,99999);
	/*
	...
	*/
	...
	/*
		...
		in index.php
	*/
	$security_number2 = empty($_SESSION['security_number2']) ? 'error' : $_SESSION['security_number2'];
	$image_text=$security_number2;
	/*
	...
	*/
	...
	/*
		...
		capcha image
	*/
	$text=imagettftext($img,21,rand(-10,10),rand(5,10),rand(35,35),$text_color,"fonts/courbd.ttf",$image_text);
	/*
