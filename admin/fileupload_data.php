        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                function loadData(page){
                    ...
                    ({
                        type: "POST",
                        url: "../stockupload/admin/item_search.php",
                        data: { page : page,
...
//include('../stockupload/include/login_check.php');	
if($_POST['page'])
{
...
$query_pag_data="SELECT * FROM stock_tb LIMIT $start, $per_page";
				$stmt_page_data	= $db_con->prepare($query_pag_data);
				$stmt_page_data ->execute();
$msg = "";

/*--------------------------------------------- */
$query_pag_num 	= "SELECT COUNT(*) AS count FROM `stock_tb`";
 ...
 <!--Box-->    
            ...
            <!-- Box -->
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Stock</h2>
						<div class="right">
						<label>search item</label>
			<input type="text" name="item_search" id="item_search" value="" class="field small-field" onchange="searchButton();"/>
...
$goto = "<input type='text' class='goto' size='1' style='margin-top:-1px;margin-left:10px; height:17px;'/><input type='button' id='go_btn' class='go_button' value='Go' style='margin-left:10px;'/>";
